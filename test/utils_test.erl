...
pack_test() ->
   MyList = [1,2,3,-1,-2,-3,4,5,6,-6,-5,-4],
   ?assertEqual([{1,2,3},{-1,-2,-3},{4,5,6},{-6,-5,-4}]
               ,pack_components(MyList)).
...
%   
% mtx_wilson_test() ->
%     A = #molecule{cart=[[0.0,0.0,0.0],[0.00000000e+00,  0.00000000e+00, 2.05791176e+00],[1.94021962e+00,  0.00000000e+00, -6.85963027e-01],[-9.70109808e-01, -1.68027834e+00, -6.85970586e-01]],
